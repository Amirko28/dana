...
export const IntroQuestion = () => (
    <div
        dir="rtl"
        className="flex h-screen w-screen flex-col items-center justify-center space-y-6 bg-zinc-800 font-body"
    >
        <div className="flex h-fit w-5/6 flex-col space-y-6 lg:w-11/12">
            <Link href="/form">
                <div
                    className={`
                ${labelClassName}
