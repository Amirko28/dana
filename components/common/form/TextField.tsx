...
export const TextField = ({ displayName, register, fieldError }: Props) => {
    return (
        <div className={`${labelClassName} relative z-0 h-20 w-40 -space-y-2 lg:w-72`}>
            ...
            <label
                htmlFor={displayName}
                className="absolute top-3 -z-10 flex origin-[0] -translate-y-6 translate-x-1/4 scale-75 truncate whitespace-pre-wrap break-words text-gray-300 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:-translate-x-0 peer-placeholder-shown:scale-100 peer-focus:right-0 peer-focus:-translate-y-6 peer-focus:translate-x-1/4 peer-focus:scale-75 peer-focus:text-blue-500"
            >
                {displayName}
            </label>
            <div className="mr-1">
